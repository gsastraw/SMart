...
public final class AccountService {
    ...
    public Account createUser(String username, String password) {
        ...
        final var userAccount = accountRepository.createUserAccount(username, username); // display name is set as the username by default
        accountCredentialsRepository
                .createUserAccountCredentials(userAccount.getAccountId(), encodedPassword.getPassword(), encodedPassword.getSalt());
